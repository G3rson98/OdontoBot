			...
			<?php 
			 ...
			 ?>	
                      ...
                      <label class="control-label col-sm-2" for="">Servicios: </label>
										...
										foreach ($servicio as $key => $value) {
												...
												if(in_array($value['id_serv'],$array_serv)){
													...
													<div class='checkbox'>
                                                    <label> <input value='".$value['id_serv']."'  type='checkbox' name='servicios[]' checked>".$nombre_servicio["nombre_ser"]."</label>                                                
													<input value='".$precio_ser['precio_serv']."' name='precio[]' class='form-control' id='precio'  placeholder='ingresar descripcion' >
													</div>
                                                    <div >
                                                    </div>
                                                    </div>";
													...
													"<div class='col-sm-offset-3'>
													<div class='checkbox'>
                                                    <label> <input value='".$value['id_serv']."'  type='checkbox' name='servicios[]'>".$nombre_servicio["nombre_ser"]."</label>
                                                    <input type='text' name='precio[]' class='form-control'  placeholder='ingresar descripcion'>
                                                    </div></div>";
												}
											}	
										}else{
				...
				<div class="form-group"> 
					...
					// echo '<pre>'; print_r($_GET); echo '</pre>';		
					echo
					"<a href='index.php?view=addconsulta&id_his=$id_hist&id_cons=$id_con&ci_per=$id_per&id_ficha=$id&id=$id' type='button' class='btn btn-default btn-md'>Cancelar</a>";
					?>
					</div>
				</div>
